...
<template>
  ...
  <base-input label="TotalUnits" type="text" placeholder="Enter TotalUnits" v-model="rackToAdd.totalUnits"></base-input>
  <base-input label="AvailableUnits" type="text" placeholder="Enter AvailableUnits" v-model="rackToAdd.availableUnits"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'totalUnits',
          visible: true,
          scopedSlots: { customRender: 'totalUnits' },
          sorter: true
          //sorter: (a, b) => a.totalUnits - b.totalUnits,
          //sorter: (a, b) => a.totalUnits.localeCompare(b.totalUnits),
        },
        {
		...
		dataIndex: 'availableUnits',
          ...
          sorter: true
          //sorter: (a, b) => a.availableUnits - b.availableUnits,
          //sorter: (a, b) => a.availableUnits.localeCompare(b.availableUnits),
        },
      ],
      pagination: {
        current: 1,
