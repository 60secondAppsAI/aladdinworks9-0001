...
<template>
  ...
  <base-input label="AlertType" type="text" placeholder="Enter AlertType" v-model="alertToAdd.alertType"></base-input>
  <base-input label="AlertLevel" type="text" placeholder="Enter AlertLevel" v-model="alertToAdd.alertLevel"></base-input>
  <base-input label="RecordedDate" type="text" placeholder="Enter RecordedDate" v-model="alertToAdd.recordedDate"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'alertType',
          ...
          sorter: true
          //sorter: (a, b) => a.alertType - b.alertType,
		...
		dataIndex: 'recordedDate',
          visible: true,
          scopedSlots: { customRender: 'recordedDate' },
          sorter: true
          //sorter: (a, b) => a.recordedDate - b.recordedDate,
          //sorter: (a, b) => a.recordedDate.localeCompare(b.recordedDate),
        },
      ],
      pagination: {
        current: 1,
