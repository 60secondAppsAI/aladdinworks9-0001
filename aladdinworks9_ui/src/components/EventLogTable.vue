...
<template>
  ...
  <base-input label="EventType" type="text" placeholder="Enter EventType" v-model="eventLogToAdd.eventType"></base-input>
  <base-input label="EventDate" type="text" placeholder="Enter EventDate" v-model="eventLogToAdd.eventDate"></base-input>
                  </form>
                </div>
