...
<template>
  ...
  <base-input label="MaxCurrent" type="text" placeholder="Enter MaxCurrent" v-model="powerStripToAdd.maxCurrent"></base-input>
  <base-input label="CurrentLoad" type="text" placeholder="Enter CurrentLoad" v-model="powerStripToAdd.currentLoad"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'maxCurrent',
          visible: true,
          scopedSlots: { customRender: 'maxCurrent' },
          sorter: true
          //sorter: (a, b) => a.maxCurrent - b.maxCurrent,
          //sorter: (a, b) => a.maxCurrent.localeCompare(b.maxCurrent),
        },
        {
          title: 'Current Load',
		dataIndex: 'currentLoad',
          visible: true,
          scopedSlots: { customRender: 'currentLoad' },
          sorter: true
          //sorter: (a, b) => a.currentLoad - b.currentLoad,
          //sorter: (a, b) => a.currentLoad.localeCompare(b.currentLoad),
        },
      ],
      pagination: {
        current: 1,
