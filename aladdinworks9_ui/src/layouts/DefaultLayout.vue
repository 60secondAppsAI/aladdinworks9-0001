...
-->>
				...
				<a-menu-item>
					<router-link to="/surveillanceCameras">
						<span class="label">Surveillance Cameras</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/capacityReports">
						<span class="label">Capacity Reports</span>
					</router-link>
				</a-menu-item>
		
				<a-menu-item>
					<router-link to="/energyConsumptions">
						<span class="label">Energy Consumptions</span>
					</router-link>
				</a-menu-item>
				...
				<a-menu-item>
					<router-link to="/issueResolutions">
						<span class="label">Issue Resolutions</span>
					</router-link>
				</a-menu-item>
